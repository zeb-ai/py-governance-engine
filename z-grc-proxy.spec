...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'zgrc.utils.model_resolver',
        'zgrc.utils.cost_calculator',
        'zgrc.observability',
        'zgrc.observability.logs',
        'zgrc.observability.traces',
        'zgrc.observability.metrics',
        'zgrc.observability.base_telemetry',
        'zgrc.observability.auto_instrumentation',
        'zgrc.interceptors.models',
        'zgrc.providers',
        'opentelemetry',
        'opentelemetry.trace',
