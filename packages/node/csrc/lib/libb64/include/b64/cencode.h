...
extern size_t base64_encode_length(size_t plain_len,
                                   base64_encodestate *state_in);

extern char base64_encode_value(signed char value_in);
extern size_t base64_encode_block(const void *plaintext_in,
                                  const size_t length_in, char *code_out,
                                  base64_encodestate *state_in);
extern size_t base64_encode_blockend(char *code_out,
                                     base64_encodestate *state_in);
